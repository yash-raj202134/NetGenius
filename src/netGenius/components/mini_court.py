...
import os
import numpy as np
from src.netGenius import constants as const
...
class MiniCourt():
    ...
    def set_court_drawing_key_points(self):
        ...
        drawing_key_points[5] = self.court_start_y + convert_meters_to_pixel_distance(const.HALF_COURT_LINE_HEIGHT*2,
        ...
        # point 4
        drawing_key_points[8] = drawing_key_points[0] + convert_meters_to_pixel_distance(const.DOUBLE_ALLY_DIFFERENCE,const.DOUBLE_LINE_WIDTH,self.court_drawing_width)
        drawing_key_points[9] = drawing_key_points[1]

        # point 5
        drawing_key_points[10] = drawing_key_points[4] + convert_meters_to_pixel_distance(const.DOUBLE_ALLY_DIFFERENCE,const.DOUBLE_LINE_WIDTH,self.court_drawing_width)
        drawing_key_points[11] = drawing_key_points[5]

        # point 6
        drawing_key_points[12] = drawing_key_points[2] -  convert_meters_to_pixel_distance(const.DOUBLE_ALLY_DIFFERENCE,const.DOUBLE_LINE_WIDTH,self.court_drawing_width)
        drawing_key_points[13] = drawing_key_points[3]

        # point 7
        drawing_key_points[14] = drawing_key_points[6] -  convert_meters_to_pixel_distance(const.DOUBLE_ALLY_DIFFERENCE,const.DOUBLE_LINE_WIDTH,self.court_drawing_width)
        drawing_key_points[15] = drawing_key_points[7]

        # point 8
        drawing_key_points[16] = drawing_key_points[8]
        drawing_key_points[17] = drawing_key_points[9] +  convert_meters_to_pixel_distance(const.NO_MANS_LAND_HEIGHT,const.DOUBLE_LINE_WIDTH,self.court_drawing_width)

        # point 9
        drawing_key_points[18] = drawing_key_points[16] +  convert_meters_to_pixel_distance(const.SINGLE_LINE_WIDTH,const.DOUBLE_LINE_WIDTH,self.court_drawing_width)
        drawing_key_points[19] = drawing_key_points[17]

        # point 10
        drawing_key_points[20] = drawing_key_points[10]
        drawing_key_points[21] = drawing_key_points[11] -  convert_meters_to_pixel_distance(const.NO_MANS_LAND_HEIGHT,const.DOUBLE_LINE_WIDTH,self.court_drawing_width)

        # point 11
        drawing_key_points[22] = drawing_key_points[20] +  convert_meters_to_pixel_distance(const.SINGLE_LINE_WIDTH,const.DOUBLE_LINE_WIDTH,self.court_drawing_width)
    ...
    def get_mini_court_coordinates(self,
        ...
        mini_court_x_distance_pixels = convert_meters_to_pixel_distance(distance_from_keypoint_x_meters,
                                                                        const.DOUBLE_LINE_WIDTH,
                                                                        self.court_drawing_width)
        mini_court_y_distance_pixels = convert_meters_to_pixel_distance(distance_from_keypoint_y_meters,
                                                                        const.DOUBLE_LINE_WIDTH,
                                                                        self.court_drawing_width)
